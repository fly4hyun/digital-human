...
from main_function_webcam import camera_human_seg_with_pic
...
parser.add_argument('--delay_time', required = False, default = 0., 
...
pic = cv2.imread('./kimgoo.jpg')

##########################################################################################

while(True):
    
    elapsed_time = camera_human_seg_with_pic(model, cap, x, y, threshold, pic)
