...
def LiDAR_camera_function(pipeline, 
                          align, 
                          body_model, 
                          face_model, 
                          x,
    ...
    measures = []
    for x_one, y_one in x_y:
        measures.append(round((depth_info.get_distance(x_one, y_one) * 100), 2))
    ...
    return measure, check_human, elapsed_time

##########################################################################################

def LiDAR_camera_view(pipeline, 
                      align, 
                      body_model, 
                      face_model, 
                      x,
    ...
    for x, y in x_y:
        ...
        cv2.putText(frame, str(measures[i])[:3], (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), thickness)
        i+=1
